	            ...
	            <div class="col-md-12">
	                <div class="box box-info">
	                    <div class="box-header with-border">
	                        <h3 class="box-title">修改产品分类</h3>
	                    </div>
	                    <form class="form-horizontal" action="/RJDZ/productType?type=upd" method="post">
	                        <div class="box-body">
	                            <div class="form-group">
	                                <label for="txtALoginName" class="col-sm-2 control-label">产品分类名称：</label>
	                                <div class="col-sm-10">
	                                	<input type="hidden" name="pageNo" value="${requestScope.pageNo }">
	                                	<input type="hidden" name="pid" value="${requestScope.pType.pid }">
	                                	<input type="text" id="pName" name="pName" class="form-control" placeholder="请输入产品分类名称" value="${requestScope.pType.pname }"/>
	                                </div>
	                            </div>	                         
	                        </div>
