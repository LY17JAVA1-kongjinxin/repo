	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-info">
				...
				<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/upd"
					method="post">
					<div class="box-body">
						<div class="form-group">
							<label for="aLoginName" class="col-sm-2 control-label">管理员帐号：</label>
							<div class="col-sm-10">
								<input type="hidden" name="aid" value="${requestScope.admin.aid }"/>
								<input type="hidden" name="pageNo" value="${requestScope.pageNo }"/>
								<input type="text" id="aLoginName" name="aLoginName" class="form-control"
									placeholder="请输入管理员帐号" value="${requestScope.admin.aLoginName }"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" id="aTrueName" name="aTrueName" class="form-control"
									placeholder="请输入管理员真实名称" value="${requestScope.admin.aTrueName }"/>
							</div>
						</div>
					</div>
