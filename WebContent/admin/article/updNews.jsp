	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-info">
				...
				<form class="form-horizontal" action="/RJDZ/news?type=upd"
					method="post">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<input type="text" id="nTitle" name="nTitle" class="form-control"
									placeholder="请输入新闻标题" value="${requestScope.news.ntitle }"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" id="nDesc" name="nDesc" class="form-control"
									placeholder="请输入新闻标题" value="${requestScope.news.ndesc }"/>
							</div>
						</div>
					</div>
